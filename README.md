...
화면공유 중에 실시간으로 그림을 그릴 수 있습니다:

**판서 도구 열기:**
- 화면공유 시작 시 자동으로 판서 도구 패널 표시
- 우측에 고정된 도구 패널

**그리기:**
1. **🖊️ 펜 모드**: 기본 그리기 모드
2. **색상 선택**: 컬러 픽커로 원하는 색상 선택
3. **굵기 조절**: 슬라이더로 1~20px 조절
4. **마우스/터치로 그리기**: 화면에 직접 그리기

**지우기:**
1. **🧹 지우개**: 지우개 모드로 전환
2. **🗑️ 전체삭제**: 모든 그림 한 번에 삭제

**닫기:**
- **✕ 버튼**: 판서 도구 패널 숨기기
- 화면공유 종료 시 자동으로 판서 도구 제거
