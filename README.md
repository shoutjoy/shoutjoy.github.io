...
화면공유 중에 실시간으로 그림을 그리고 포인터로 강조할 수 있습니다:

**판서 시작:**
1. **화면공유** 시작 (교사 또는 학생)
2. 컨트롤 바에 **✏️ 판서** 버튼이 표시됨
3. **✏️ 판서** 버튼 클릭
...
- **🖊️ 펜**: 그리기 모드 (기본)
- **🧹 지우개**: 지우개 모드
- **🔴 포인터**: 붉은 점 포인터로 강조 표시 (마우스 이동 시만 보임)
- **🗑️ 전체삭제**: 모든 그림 한 번에 삭제

**포인터 기능:**
- 그리지 않고 특정 부분만 가리킬 때 사용
- 마우스/터치 이동 시 붉은 점으로 표시
- 마우스를 떼면 자동으로 사라짐
- 발표 중 강조할 부분 지적에 유용
